(function () {
    ...
    Zergling.prototype = {
        ...
        findTarget: function () {
            ...
            for (radius = 10; radius < Zergling.VISION; radius += 100) {
        ...
        pulsate: function () {
            if (this.dPulsate = !this.dPulsate) {
                this.dom.css({
                    ...
                    height: document.body.offsetWidth/80
                });
            } else {
                this.dom.css({
                    left: this.x,
                    ...
                    height: document.body.offsetWidth/100
                });
            }
        }
    ...
    function ZergRush(nZerglings) {//叫出zerg
        ...
        for (var i = 0; i < nZerglings; ++i) {
            zerglings.push(
                new Zergling(
                    random() * document.body.offsetWidth/8,
                    random() * document.body.offsetWidth/8,
                    this
                )
            );
...
let EggStatus = 0
function EggHatch(){
    document.getElementById("Zerg_egg_show").style.display = "none"
    document.getElementById("Zerg_egg_hide").style.display = "block"
    EggStatus++
    if(EggStatus == 1){
        document.getElementsByClassName("EasterEgg")[0].style.display = "block"
        alert("Click egg to show??")
    }
    if(EggStatus == 5){
        document.getElementsByClassName("EasterEgg")[0].style.display = "none"
        document.getElementsByClassName("EasterEgg")[1].style.display = "block"
    }
    if(EggStatus == 9){
        document.getElementsByClassName("EasterEgg")[1].style.display = "none"
        document.getElementsByClassName("EasterEgg")[2].style.display = "block"
        go()
        alert("thie web is under attack!")
    }
}
function EggHide(){
    if(z)z.destroy(); z = null;//消除Zerg
    document.getElementById("Zerg_egg_show").style.display = "block"
    document.getElementById("Zerg_egg_hide").style.display = "none"
    document.getElementsByClassName("EasterEgg")[0].style.display = "none"
    document.getElementsByClassName("EasterEgg")[1].style.display = "none"
    document.getElementsByClassName("EasterEgg")[2].style.display = "none"
    EggStatus = 0
}